...
export const FRIDGE_PHOTOS: Record<string, { src: string; alt: string; contents: string; clues: FridgeClue[] }> = {
  'walk-in': {
    src: walkIn,
  ...
  'larder-1': {
    ...
    clues: [
      { id: 'top-shelf', label: 'Check the top shelf', finding: 'The ready-to-eat food is covered and sitting above the raw ingredients.', x: 48, y: 31 },
      { id: 'door', label: 'Check the door', finding: 'The door shuts cleanly and the seal looks sound.', x: 88, y: 57 },
    ],
  },
  'larder-2': {
    src: larderTwo,
    ...
    clues: [
      { id: 'door', label: 'Check the door', finding: 'The door is shut now, but the seal feels warm. This matches the overnight log.', x: 88, y: 54 },
  ...
  fish: {
    ...
    clues: [
      { id: 'fish-trays', label: 'Check the fish', finding: 'The fish is covered, separated and sitting over ice. It feels properly cold.', x: 52, y: 59 },
      { id: 'drip', label: 'Check below', finding: 'The shelf underneath is clean and dry. Nothing is dripping onto another tray.', x: 48, y: 79 },
    ],
  },
  dairy: {
    src: dairy,
    ...
    clues: [
      { id: 'dairy', label: 'Check the dairy', finding: 'The milk and cream are sealed and in date. Everything feels chilled.', x: 34, y: 46 },
      { id: 'pastry', label: 'Check the pastry cream', finding: 'The pastry cream is covered and labelled. Nothing needs adding to the note.', x: 69, y: 67 },
    ],
  },
  'freezer-1': {
    src: freezerOne,
    ...
    clues: [
      { id: 'packs', label: 'Check the packs', finding: 'The packs are frozen solid with no soft edges or liquid in the trays.', x: 48, y: 54 },
      { id: 'ice', label: 'Check for ice', finding: 'There is no heavy ice build-up around the door or shelves.', x: 80, y: 30 },
    ],
  },
  'freezer-2': {
    src: freezerTwo,
    ...
    clues: [
      { id: 'berries', label: 'Check the berries', finding: 'The berries are loose in the bag, not frozen into one solid block.', x: 35, y: 58 },
      { id: 'pastry', label: 'Check the pastry', finding: 'The pastry portions are sealed and frozen hard. Nothing needs adding to the note.', x: 67, y: 42 },
    ],
  },
};