import type { DietaryState, ChecklistItem, GuestAssignment } from './simulation';
import type {
...
import { wrongChartRows } from './simulation';
import {
  ALLERGEN_REFERENCE,
  CHART_HINTS,
  DIETARY_HINTS,
  ...
  OUT_OF_SCOPE_ITEMS,
} from '@client/content/scenes/dietary-redesign';
