...
import { FRIDGE_UNITS, HANDOVER_LINES } from '@client/content/activities';
import { InspectionMedia } from './inspection-media';
import { DialThermometer } from '@kit/dial-thermometer';
...
import type { HandoverState } from '@client/lib/simulation';
import { FLAGGED_FRIDGE_ID, handoverRowComplete } from '@client/lib/handover-round';
...
import { FRIDGE_INTERACTION_COPY } from '@client/content/fridge-interaction-copy';
