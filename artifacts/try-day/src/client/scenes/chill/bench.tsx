...
import { traysHaveSpace } from '@client/lib/simulation';
import { useKitchen, useKitchenAction, useWorkspaceOpen } from '@shell/frame/kitchen-context';
import { DragProvider } from '@kit/interact/index';
