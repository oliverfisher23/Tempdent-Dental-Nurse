...
import { PREP_SHEET, CHILLER_SHELVES, CHILL_RULES, YOUR_TRAY_READINGS, PROBE_PLACEMENTS, nextChillMark, type ProbePlacementId, type ChillInterval } from '@client/content/activities';
import { CHILL_LABELS as L } from '@client/content/scenes/chill';
import { CoolingRecordSummary } from './cooling-record-summary';
import { parseNumber, readingIsRight, traysHaveSpace, type ChillState } from '@client/lib/simulation';
import { useProgress } from '@client/lib/progress';
import { useFocusTrap } from '@shell/frame/use-focus-trap';
import { kitchenAudio } from '@kit/lib/audio';
import { scrollWithinScroller } from '@shell/lib/scroll';
import { Button } from '@kit/ui/button';
import { Input } from '@kit/ui/input';
import { cn, upperFirst } from '@kit/lib/utils';
import { useDraggable, useDropZone, HoldToRead } from '@kit/interact/index';
import { TRAY_DEPTH_MM, type ChillActions } from './types';
import { AnalogueThermometer } from '@kit/analogue-thermometer';
