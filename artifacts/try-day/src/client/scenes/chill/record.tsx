...
import { CHILL_RULES, MARCUS_TRAY_READINGS, MEASURED_DEPTHS_MM, PREP_SHEET, type ChillInterval } from '@client/content/activities';
import { CHILL_LABELS as L } from '@client/content/scenes/chill';
import { evaluateChill, readingIsRight, type ChillState } from '@client/lib/simulation';
import { useProgress } from '@client/lib/progress';
import { useNotepad } from '@shell/frame/notepad';
import { Clipboard } from '@kit/paper';
import { CloseUp } from '@shell/frame/close-up';
import { SignaturePad, type SignatureValue } from '@kit/interact/index';
