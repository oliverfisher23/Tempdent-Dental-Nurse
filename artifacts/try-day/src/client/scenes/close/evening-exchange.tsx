...
import { HANDOVER_FIELDS } from '@client/content/activities';
import { CLOSE_SCENE } from '@client/content/scenes/close';
import { EVENING_EXCHANGE, EXCHANGE_COPY, TIMING_CHALLENGE, exchangeText, type ExchangeTopic } from '@client/content/scenes/close-exchange';
import type { CloseEvidence } from '@client/lib/close-evidence';
import type { CloseRedesignState } from '@client/lib/redesign-types';
import { answerKey, timingIssues, topicResolved, type FollowUpId } from '@client/lib/redesign-close';
