...
import { TEAM_EVIDENCE, exchangeText } from '@client/content/scenes/close-exchange';
import { useProgress } from '@client/lib/progress';
import { buildCloseEvidence, type CloseEvidence } from '@client/lib/close-evidence';
import type { CloseRedesignState } from '@client/lib/redesign-types';
import { clearAnswersForHeading, followUpsGrouped, headingsFilled, isHandoverReady, type FollowUpId } from '@client/lib/redesign-close';
