...
import { ADDED_GUESTS, type AddedGuest, type Line } from '@client/content/activities';
import { DECISION_ACTIONS, DECISION_CATEGORIES, OUT_OF_SCOPE_ITEMS } from '@client/content/scenes/dietary-redesign';
import { DIETARY_UI } from '@client/content/scenes/dietary-interaction';
import type { GuestAssignment } from '@client/lib/simulation';
import {
  COURSES,
  PLANNED_DISH,
  allergenLabel,
