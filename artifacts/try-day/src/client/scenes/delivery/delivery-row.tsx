...
import { CHECK_COPY } from '@kit/check';
...
import { DELIVERY_LINES, FISH_CHECKS, ORDER_LINES, REFUSED_LINE_ID } from '@client/content/activities';
import { CRATE_IMAGES } from '@client/content/kitchen';
import { lowerFirst } from '@kit/lib/utils';
import { AnalogueThermometer } from '@kit/analogue-thermometer';
import { KitchenScale, scaleReading, type ScalePhase } from '@kit/kitchen-scale';
import { kitchenAudio } from '@kit/lib/audio';
import { useProgress } from '@client/lib/progress';
import { deliveryLineIssues } from '@client/lib/delivery-workflow';
import { ROW_LABELS } from '@client/content/scenes/delivery-row';
import type { DeliveryState, OrderLineState } from '@client/lib/simulation';
