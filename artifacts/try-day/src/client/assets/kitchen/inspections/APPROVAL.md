...
`src/client/content/fridge-media.json`. Findings below are quoted unchanged from
...
recorded. On 2026-09-22 the two source files moved from `src/content/` to
`src/client/content/` with their contents, and therefore their fingerprints,
unchanged. They identify files, not media ownership or food-safety evidence.
Changed media or findings are not automatically covered by this sign-off.

| Item | SHA-256 |
| --- | --- |
| `src/client/content/fridge-media.json` | `a4702f89858c156f75766114c3fd456edf6b8ba3384a08669afce1c4ec89ff72` |
| `src/client/content/fridge-photos.ts` | `142c2cd19faaa58342d41e594a61a457433e196c47ad16c16796d1b305d97ae4` |
