...
import { FRAME, GATE, formatC } from "@client/lib/simulation";
import {
  ADDED_GUESTS,
  ARTOTEL_LINES,
  CHILL_RULES,
...
import { COMPLETION_ACCESSIBILITY_COPY as COPY } from "@client/content/accessibility-media";
