...
import { BenchScene } from "@client/scenes/chill/bench";
import type { ChillActions } from "@client/scenes/chill/types";
import { TRAY_DEPTH_MM } from "@client/scenes/chill/types";
import { useProgress } from "@client/lib/progress";
import { PREP_SHEET, CHILL_RULES, PROBE_PLACEMENTS, NINETY_MINUTE_CHOICES, CHILL_LINES, nextChillMark, type Line, type ProbePlacementId, type NinetyMinuteChoiceId, type ChillInterval } from "@client/content/activities";
import { CHILL_LABELS as L } from "@client/content/scenes/chill";
import { addMinutes, traysHaveSpace } from "@client/lib/simulation";
import { kitchenAudio } from "@kit/lib/audio";
import { cn } from "@kit/lib/utils";
import { getChillGuide } from "@client/content/guides/chill";
