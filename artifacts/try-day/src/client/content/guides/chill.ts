import { CHILL_RULES, PREP_SHEET, nextChillMark, type ChillInterval } from '@client/content/activities';
import { CHILL_LABELS as L, describeMinutes } from '@client/content/scenes/chill';
import type { InteractionPatternId } from '@client/content/interaction-patterns';
import type { StepGuide } from '@shell/copy/step-guide';
import { readingIsRight, traysHaveSpace, type ChillState } from '@client/lib/simulation';
