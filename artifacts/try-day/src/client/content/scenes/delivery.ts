export const SCENE_LABELS = {
  ...
  workspace: {
    opener: {
      ...
      comparison: {
        what: "Work out the salmon shortfall.",
        how: "Compare the three amounts. Enter what is missing. Prepare the salmon amendment.",
        done: "The shortfall is checked and the salmon amendment is saved.",
      },
      report: {
      ...
      note: {
        what: "Complete and sign the delivery note.",
        how: "Amend every line where what you took in differs from the supplier's claim. Initial each amendment. Review the note, then sign it.",
        done: "Every amendment is initialled and the note is signed.",
      },
      review: {
    ...
    support: "Start with chicken for a short guide to the method, or choose any item.",
    inspectionProgress: (counted: number, probed: number, fish: number) =>
      `${counted}/6 quantities checked · ${probed}/4 temperatures taken · ${fish}/4 fish findings inspected`,
    navigationLocked: {
