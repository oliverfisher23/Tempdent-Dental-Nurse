...
Original generated JPEGs are in `attached_assets/generated_images/task1-*-photo.jpg`.
The app uses compressed local WebP copies. No remote image requests are needed.
