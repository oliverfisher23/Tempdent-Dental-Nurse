...
|---|---|---|---|
| 1 Set up | 9 decisions, 32 taps: order cards, tap 7 surfaces, choose, tick kit, tick 10 tray items | 8 decisions, about 24 actions: spot what's wrong with you in the mirror, wash and touch only what should be touched, find four things wrong in the room, wipe in one path, hold the flush, read five labels and decide about one, build the tray and set the bad pouch aside | spot, notice, sweep, hold, read, decide, place |
...
| 2 | **Handwash, then PPE.** Wash your hands the 12-step way, then put on your PPE. | 12-step poster; the sink and PPE station close-up; the learner's own hands | **What touches what.** The record is what the learner's hands touch, in order. Press and hold the tap: the poster's first ten steps light one by one while the learner holds (about five seconds, compressed); letting go early restarts the count. The tap is left running. Then everything at the station can be touched: the paper towels, the tap, the PPE station, the gloves box, and two things that are always there: the tunic and the phone. Nothing is refused: a touch that dirties clean hands (tap by hand, tunic, phone) marks the hands picture and says one line, and the route carries on. The PPE station is one tap-through with gloves last (apron, mask, visor: shown, not tested). Touching the gloves box ends the route. Gloves box first is a one-touch route: Priya's V1 line plays and the gloves stay in the box. | Judged whole: wash, dry with the paper towel, tap off with the towel, PPE, gloves last. Anything else in the route (phone, tunic, tap by hand, PPE before the wash) gets Priya's V1 "what touches what" line and a fresh start. |
...
| Handwash or PPE first? | Changed (recorded route instead of order cards) | Wash, paper towel, tap off with the towel, PPE, gloves last | Gloves or PPE before the wash; tap off by hand; drying on the tunic; the phone; letting go of the tap early | V1 lines unchanged for right and wrong; early release: "All twelve. It takes as long as it takes — start again." (**TBC**). World lines on a touch, one each (**TBC SME**): tap by hand "Dirty hands turned that tap on. Clean ones have just touched it."; tap with the towel "Tap off with the towel, towel in the bin."; paper towel "Single use. Pat dry, wrists too."; tunic "That tunic came in on the bus with you."; phone "A phone goes everywhere you do, and it is never clean." |
...
| Fresh handwash before the cupboard | Changed (world rule instead of a question; the same "what touches what" sink as step 2, arriving in the gloves and apron from the wipe) | Used gloves and apron off into clinical waste, wash, paper towel, tap off with the towel, fresh apron, fresh gloves; then open | Opening the cupboard in the gloves you wiped in; washing with the gloves still on; fresh gloves without the wash; the same dirty touches as step 2 | Cupboard: "Those gloves have just done the spittoon. Fresh hands before anything goes near a tray." (**TBC**). Tap held in the gloves: "That's washing the gloves, not your hands." (**TBC SME**). Gloves and apron off: "Gloves and apron into the clinical waste, inside out." (**TBC SME**). V1 right and wrong lines unchanged. |
...
|---|---|---|
| The learner is correctly presented (mirror item put right), has completed the held handwash and put on PPE before entering, and has washed and gloved again before opening the instrument cupboard | Mirror fix, both handwash routes recorded whole (what the hands touched, in order), cupboard-open timestamp after the second route | Yes |
...
- Sink and PPE station close-up from the learner's eye level (tap, paper towel dispenser, apron, mask and visor on the rack, gloves box, the phone on the worktop, the tunic at the edge of frame), ideally with the tap off; and the learner's own hands, palms up, for the "what touches what" hands picture. Placeholder AI stills until Tempdent photography.
...
3. The handwash is compressed to about five seconds on screen. Is showing the first ten steps lighting in sequence acceptable without teaching each step, with "Dry" and "Turn tap off" lit by what the hands then do?
3a. The "what touches what" route: the answer key is wash, paper towel, tap off with the towel, PPE (apron, mask, visor), gloves last; for the second wash, used gloves and apron off first and a fresh apron before the gloves. Is that the routine Tempdent teaches, and are the one-line world reactions (tunic, phone, tap by hand, towel) right?
