...
- `artifacts/try-day/src/assets/` — `be-logo.svg` (the "Be | Marriott Bonvoy" lock-up), `sous-chef.webp` (intro photo; rights unconfirmed by client), `kitchen/` (AI-generated isometric map, illustrated goods-in and events backdrops, fridge interiors, legacy portraits), `kitchen/photos/` (client photographs of Terence: welcome hero, briefing circle at 1x and 2x, dialogue avatar, pass, fridges and bench backdrops), `public/audio/kitchen-ambience.mp3`.
